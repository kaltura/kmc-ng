...
import { KalturaMetadataProfile } from '@kaltura-ng/kaltura-client/api/types/KalturaMetadataProfile';

import {
	KalturaMetadataProfileStatus
} from '@kaltura-ng/kaltura-client/api/types/KalturaMetadataProfileStatus'
