...
export enum KMCPermissions {
    ...
    'FEATURE_DISABLE_PREVIEW_PAGE' = 1143,
    'VIEW_MODERATED_SYSTEM_ENTRIES' = 1144,
    ...
    'FEATURE_CONTENT_LAB' = 1150,
    'FEATURE_V2_V7_REDIRECT' = 1151,
    'FEATURE_AGENTS_FRAMEWORK_PERMISSION' = 1152,
    'FEATURE_GENIE_PERMISSION' = 1152
}
