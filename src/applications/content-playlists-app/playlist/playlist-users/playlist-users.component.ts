...
import { PlaylistUsersWidget } from './playlist-users-widget.service';
import { BrowserService } from 'app-shared/kmc-shell/providers';
import { KMCPermissions } from 'app-shared/kmc-shared/kmc-permissions';

@Component({
  selector: 'kPlaylistUsers',
  templateUrl: './playlist-users.component.html',
  styleUrls: ['./playlist-users.component.scss']
})
export class PlaylistUsers implements AfterViewInit, OnInit, OnDestroy {
	...
	constructor(public _widgetService: PlaylistUsersWidget,
