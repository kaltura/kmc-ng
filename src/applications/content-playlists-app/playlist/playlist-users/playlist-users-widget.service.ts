...
import {
    ...
    KalturaESearchUserResult, KalturaBaseEntry
...
@Injectable()
export class PlaylistUsersWidget extends PlaylistWidget implements OnDestroy
{
    ...
    {
        super(ContentPlaylistViewSections.Users, logger);
	    this._buildForm();
    }
	...
	protected onDataSaving(data: KalturaBaseEntry, request: KalturaMultiRequest){
