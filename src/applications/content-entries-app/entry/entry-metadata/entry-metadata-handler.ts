...
import { KalturaCategoryEntryFilter,  KalturaMediaEntry } from 'kaltura-ts-api/types';
import { KalturaServerClient } from 'kaltura-ts-api';
import { KalturaTagFilter, KalturaTaggedObjectType, KalturaFilterPager,
    TagSearchAction, CategoryEntryListAction, KalturaLiveStreamEntry } from 'kaltura-ts-api/types';
...
import { MetadataListAction, KalturaMetadataFilter, KalturaMetadata, MetadataUpdateAction, MetadataAddAction, KalturaMetadataObjectType, CategoryEntryAddAction, CategoryEntryDeleteAction, KalturaCategoryEntry } from 'kaltura-ts-api/types';
