...
import { ThumbAssetListAction } from '@kaltura-ng/kaltura-client/api/types/ThumbAssetListAction';
import { ThumbAssetSetAsDefaultAction } from '@kaltura-ng/kaltura-client/api/types/ThumbAssetSetAsDefaultAction';
import { KalturaThumbAssetListResponse } from '@kaltura-ng/kaltura-client/api/types/KalturaThumbAssetListResponse';
import { KalturaThumbAsset } from '@kaltura-ng/kaltura-client/api/types/KalturaThumbAsset';
import { KalturaAssetFilter } from '@kaltura-ng/kaltura-client/api/types/KalturaAssetFilter';
import { DistributionProfileListAction } from '@kaltura-ng/kaltura-client/api/types/DistributionProfileListAction';
import { KalturaDistributionProfileListResponse } from '@kaltura-ng/kaltura-client/api/types/KalturaDistributionProfileListResponse';
import { KalturaDistributionProfile } from '@kaltura-ng/kaltura-client/api/types/KalturaDistributionProfile';
import { KalturaThumbAssetStatus } from '@kaltura-ng/kaltura-client/api/types/KalturaThumbAssetStatus';
import { KalturaDistributionThumbDimensions } from '@kaltura-ng/kaltura-client/api/types/KalturaDistributionThumbDimensions';
import { ThumbAssetDeleteAction } from '@kaltura-ng/kaltura-client/api/types/ThumbAssetDeleteAction';
import { ThumbAssetAddFromImageAction } from '@kaltura-ng/kaltura-client/api/types/ThumbAssetAddFromImageAction';
