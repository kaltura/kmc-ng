...
import { KalturaFlavorAsset } from '@kaltura-ng/kaltura-client/api/types/KalturaFlavorAsset';
import { KalturaFlavorAssetWithParams } from '@kaltura-ng/kaltura-client/api/types/KalturaFlavorAssetWithParams';
import { FlavorAssetGetFlavorAssetsWithParamsAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetGetFlavorAssetsWithParamsAction';
import { KalturaFlavorAssetStatus } from '@kaltura-ng/kaltura-client/api/types/KalturaFlavorAssetStatus';
import { KalturaLiveParams } from '@kaltura-ng/kaltura-client/api/types/KalturaLiveParams';
import { KalturaEntryStatus } from '@kaltura-ng/kaltura-client/api/types/KalturaEntryStatus';
import { KalturaWidevineFlavorAsset } from '@kaltura-ng/kaltura-client/api/types/KalturaWidevineFlavorAsset';
import { FlavorAssetDeleteAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetDeleteAction';
import { FlavorAssetConvertAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetConvertAction';
import { FlavorAssetReconvertAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetReconvertAction';
import { FlavorAssetSetContentAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetSetContentAction';
import { FlavorAssetAddAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetAddAction';
import { KalturaUrlResource } from '@kaltura-ng/kaltura-client/api/types/KalturaUrlResource';
import { KalturaContentResource } from '@kaltura-ng/kaltura-client/api/types/KalturaContentResource';
import { UploadManagement } from '@kaltura-ng/kaltura-common/upload-management';
import { environment } from 'app-environment';
import { Flavor } from './flavor';
import { FlavorAssetGetUrlAction } from '@kaltura-ng/kaltura-client/api/types/FlavorAssetGetUrlAction';
