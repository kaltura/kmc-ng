...
import { DocumentThumbnailsWidget, ThumbnailRow } from './document-thumbnails-widget.service';
import { Menu } from 'primeng/menu';
import { KMCPermissions } from 'app-shared/kmc-shared/kmc-permissions';
import { MenuItem } from 'primeng/api';

@Component({
    selector: 'kDocumentThumbnails',
    templateUrl: './document-thumbnails.component.html',
    styleUrls: ['./document-thumbnails.component.scss']
})
export class DocumentThumbnails implements OnInit, OnDestroy {
  ...
  onWindowResize() {
	...
	constructor(public _widgetService: DocumentThumbnailsWidget,
