...
@Component({
    selector: 'kDocumentRelatedEdit',
    templateUrl: './document-related-edit.component.html',
    styleUrls: ['./document-related-edit.component.scss']
})
export class DocumentRelatedEdit implements  AfterViewInit, OnDestroy{
