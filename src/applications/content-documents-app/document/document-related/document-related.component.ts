...
import {DocumentRelatedWidget} from './document-related-widget.service';
...
@Component({
    selector: 'kDocumentRelated',
    templateUrl: './document-related.component.html',
    styleUrls: ['./document-related.component.scss']
})
export class DocumentRelated implements OnInit, AfterViewInit, OnDestroy{
  public _kmcPermissions = KMCPermissions;
	...
	constructor(public _widgetService: DocumentRelatedWidget,
