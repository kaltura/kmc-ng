...
import { KalturaCategoryEntryFilter, KalturaDocumentEntry } from 'kaltura-ngx-client';
...
@Injectable()
export class DocumentMetadataWidget extends DocumentWidget implements OnDestroy
{
    ...
    private _loadEntryMetadata(entry : KalturaDocumentEntry) : Observable<boolean> {
    ...
    private _loadEntryCategories(entry : KalturaDocumentEntry) : Observable<boolean> {
    ...
    protected onDataSaving(newData : KalturaDocumentEntry, request : KalturaMultiRequest) : void
    {
