...
import { CriteriaCreatedComponent, CriteriaPlayedComponent, CriteriaDurationComponent, CriteriaPlaysComponent, CriteriaCategoriesComponent, CriteriaTagsComponent,
    CriteriaOwnerComponent, CriteriaMetadataComponent, CriteriaAdminTagsComponent, CriteriaCaptionsComponent, CriteriaEADComponent, CriteriaSADComponent, CriteriaSchedulingComponent } from './rule/criteria/renderers';
...
import { ActionFlavourComponent, ActionCategoryComponent, ActionOwnerComponent, ActionDeleteComponent, ActionTagsComponent, ActionNotificationComponent, ActionAgentComponent } from './rule/actions/renderers';
