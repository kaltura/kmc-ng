...
export class CriteriaDurationComponent implements OnInit{
    ...
    public _timeUnitOptions: { value: string, label: string }[] = [
        {value: 'sec', label: this._appLocalization.get('applications.settings.mr.criteria.sec')},
        {value: 'min', label: this._appLocalization.get('applications.settings.mr.criteria.min')},
        {value: 'hour', label: this._appLocalization.get('applications.settings.mr.criteria.hour')}
    ];

    public enableLess = true;
    public createdLessTimeUnit = 'sec';
    public createdLessTime = 10;

    public enableMore = false;
    public createdMoreTimeUnit = 'sec';
    public createdMoreTime = 10;
