...
@Injectable()
export class RoomAccessControlWidget extends RoomWidget implements OnDestroy {
  ...
  constructor(private _accessControlProfileStore: AccessControlProfileStore,
    ...
    super(ContentRoomViewSections.AccessControl, logger);
  }
  ...
  protected onDataSaving(data: KalturaRoomEntry, request: KalturaMultiRequest) {
