...
import { RoomUsersWidget } from './room-users-widget.service';
...
export class RoomUsers implements AfterViewInit, OnInit, OnDestroy {
	...
	constructor(public _widgetService: RoomUsersWidget,
