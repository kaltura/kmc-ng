...
export class ReachServicesListComponent implements OnInit, OnDestroy {
    ...
    constructor(private _appLocalization: AppLocalization,
        ...
        this._serviceFeatures = [
            ...
            { label: this._appLocalization.get('applications.settings.reach.services.signLanguage'), value: KalturaVendorServiceFeature.signLanguage },
            { label: this._appLocalization.get('applications.settings.reach.services.liveTranslation'), value: KalturaVendorServiceFeature.liveTranslation }
        ];
    }
