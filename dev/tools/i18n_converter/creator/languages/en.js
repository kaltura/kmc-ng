var en = {
    ...
    "telephone": "Telephone",
    "comments": "Comments",
    "upgrade": "Need more KMC roles? <a href='{0}' target='_blank'><u><font color='#009acc'>Click here</font></u></a> to upgrade your account.",
    "downgrade": "Downgrade",
    "send": "Send",
    "dollarSign": "$",
    ...
    "users_tab": "Users",
    "roles_tab": "Roles",
    "usersPageDesc": "Here you can manage the KMC roles with various levels of access to your account. You can add new roles, edit permissions for existing roles and more.",
    ...
    "role_changes": "* Changes made to an active role may impact roles' current KMC sessions.",
    "after_role_edit": "Changes will take effect immediately. \\nBrowser page refresh should be recommended to the existing roles associated with this role.",
    "role_in_use": "The role you selected cannot be deleted since it is currently assigned to existing roles.",
    ...
    "count_ugcToolTip": "Number of media entries contributed by roles of type User (not administrators)",
    "count_adminToolTip": "Number of media entries contributed by roles of type Admin, this includes all uploads via KMC",
    ...
    "unique_known_usersToolTip": "Sum of unique roles, for which a user ID was passed from the publisher and had at least 1 player impression or 1 play in the given timeframe",
    ...
    "total_entriesToolTip": "Sum of entries owned by all roles in the given timeframe",
    ...
    "user_total_entriesToolTip": "Sum of entries owned by all roles in the given timeframe",
    ...
    "videoDrillDownDefaultDeletedEntitlementLbl": "The deleted entry \"{0}\" was loaded {1} times and played {2} times by {3} unique known roles",
    "videoDrillDownDefaultEntitlementLbl": "The entry <font color='#0000ff'><b><u><a href='event:popupPreviewEntry'>\"{0}\"</a></u></b></font> was loaded {1} times and played {2} times by {3} unique known roles",
    "videoDrillDownDropoffLbl": "The entry \"{0}\" had {1} average play-through",
    "videoDrillDownDropoffDeletedEntitlementLbl": "The deleted entry \"{0}\" had {1} play-through ratio by {2} unique known roles",
    "videoDrillDownDropoffEntitlementLbl": "The entry <font color='#0000ff'><b><u><a href='event:popupPreviewEntry'>\"{0}\"</a></u></b></font>  had {1} play-through ratio by {2} unique known roles",
    "videoDrillDownInteractionsLbl": "The entry \"{0}\" had {1} user interactions",
    "videoDrillDownInteractionsDeletedEntitlementLbl": "The deleted entry \"{0}\" had {1} user interactions by {2} unique known roles",
    "videoDrillDownInteractionsEntitlementLbl": "The entry <font color='#0000ff'><b><u><a href='event:popupPreviewEntry'>\"{0}\"</a></u></b></font> had {1} user interactions by {2} unique known roles",
    ...
    "endUserReportLbl": "{0} media entries were loaded {1} times and played {2} times by {3} unique known roles",
    ...
    "entryUsers": "Users",
    "usersTabDescription": "Here you can add editing and publishing rights for additional end-roles to work with this entry across applications.",
    "usrUploader": "Creator:",
    ...
    "cp_requiresAuthenticationDesc": "Content in this category is visible only to authenticated end-roles",
    "cp_privateDesc": "Visible only to roles with specific permissions to access this category's content",
    ...
    "cl_privateDesc": "Category is visible only to roles with specific permission to access this category's content",
    "whoCanAddContent": "Who Can Add Content to this Category?",
    "whoCanAddContentTooltip": "Which end-roles can add content to this category through your applications?",
    "wa_noRestrictionDesc": "Any authorized end-user",
    "wa_privateDesc": "Only end-roles with specific permission to add content to this category",
    ...
    "membersCount": "{0} end-roles have permissions to this category",
    "manage": "Manage",
    ...
    "CATEGORY_USER_ALREADY_EXISTS": "Some of the added roles were already set with permissions for this category",
    "setPermissionLevel": "Set Permission Level",
    "setPermissionLevelDesc": "This will override the permission level of all selected end-roles",
